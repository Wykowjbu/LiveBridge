...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ca(e,t,n){let r=new Float32Array(la),i=new q(0,1,0);return new ri({name:`SphericalGaussianBlur`,defines:{n:la,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ea(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function wa(){return new ri({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ea(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ta(){return new ri({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ea(),fragmentShader:`
	...
	`}var Da=class extends kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new Wr([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;function gc({className:e,style:t,rotation:n=45,speed:i=.2,colors:a=[],transparent:o=!0,autoRotate:s=0,scale:c=1,frequency:l=1,warpStrength:u=1,mouseInfluence:d=1,parallax:f=.5,noise:p=.1}){let m=(0,r.useRef)(null),h=(0,r.useRef)(null),g=(0,r.useRef)(null),_=(0,r.useRef)(null),v=(0,r.useRef)(null),y=(0,r.useRef)(n),b=(0,r.useRef)(s),x=(0,r.useRef)(new K(0,0)),S=(0,r.useRef)(new K(0,0)),C=(0,r.useRef)(8);return(0,r.useEffect)(()=>{let e=m.current,t=new hn,n=new ji(-1,1,1,-1,0,1),r=new Yr(2,2),a=Array.from({length:pc},()=>new q(0,0,0)),s=new ri({vertexShader:hc,fragmentShader:mc,uniforms:{uCanvas:{value:new K(1,1)},uTime:{value:0},uSpeed:{value:i},uRot:{value:new K(1,0)},uColorCount:{value:0},uColors:{value:a},uTransparent:{value:o?1:0},uScale:{value:c},uFrequency:{value:l},uWarpStrength:{value:u},uPointer:{value:new K(0,0)},uMouseInfluence:{value:d},uParallax:{value:f},uNoise:{value:p}},premultipliedAlpha:!0,transparent:!0});_.current=s;let w=new Mr(r,s);t.add(w);let T=new dc({antialias:!1,powerPreference:`high-performance`,alpha:!0});h.current=T,T.outputColorSpace=Le,T.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),T.setClearColor(0,o?0:1),T.domElement.style.width=`100%`,T.domElement.style.height=`100%`,T.domElement.style.display=`block`,e.appendChild(T.domElement);let E=new qi,D=()=>{let t=e.clientWidth||1,n=e.clientHeight||1;T.setSize(t,n,!1),s.uniforms.uCanvas.value.set(t,n)};if(D(),`ResizeObserver`in window){let t=new ResizeObserver(D);t.observe(e),v.current=t}else window.addEventListener(`resize`,D);let O=()=>{let e=E.getDelta(),r=E.elapsedTime;s.uniforms.uTime.value=r;let i=(y.current%360+b.current*r)*Math.PI/180,a=Math.cos(i),o=Math.sin(i);s.uniforms.uRot.value.set(a,o);let c=S.current,l=x.current,u=Math.min(1,e*C.current);c.lerp(l,u),s.uniforms.uPointer.value.copy(c),T.render(t,n),g.current=requestAnimationFrame(O)};return g.current=requestAnimationFrame(O),()=>{g.current!==null&&cancelAnimationFrame(g.current),v.current?v.current.disconnect():window.removeEventListener(`resize`,D),r.dispose(),s.dispose(),T.dispose(),T.forceContextLoss(),T.domElement&&T.domElement.parentElement===e&&e.removeChild(T.domElement)}},[l,d,p,f,c,i,o,u]),(0,r.useEffect)(()=>{let e=_.current,t=h.current;if(!e)return;y.current=n,b.current=s,e.uniforms.uSpeed.value=i,e.uniforms.uScale.value=c,e.uniforms.uFrequency.value=l,e.uniforms.uWarpStrength.value=u,e.uniforms.uMouseInfluence.value=d,e.uniforms.uParallax.value=f,e.uniforms.uNoise.value=p;let r=(a||[]).filter(Boolean).slice(0,pc).map(e=>{let t=e.replace(`#`,``).trim(),n=t.length===3?[parseInt(t[0]+t[0],16),parseInt(t[1]+t[1],16),parseInt(t[2]+t[2],16)]:[parseInt(t.slice(0,2),16),parseInt(t.slice(2,4),16),parseInt(t.slice(4,6),16)];return new q(n[0]/255,n[1]/255,n[2]/255)});for(let t=0;t<pc;t++){let n=e.uniforms.uColors.value[t];t<r.length?n.copy(r[t]):n.set(0,0,0)}e.uniforms.uColorCount.value=r.length,e.uniforms.uTransparent.value=o?1:0,t&&t.setClearColor(0,o?0:1)},[n,s,i,c,l,u,d,f,p,a,o]),(0,r.useEffect)(()=>{let e=_.current,t=m.current;if(!e||!t)return;let n=e=>{let n=t.getBoundingClientRect(),r=(e.clientX-n.left)/(n.width||1)*2-1,i=-((e.clientY-n.top)/(n.height||1)*2-1);x.current.set(r,i)};return t.addEventListener(`pointermove`,n),()=>{t.removeEventListener(`pointermove`,n)}},[]),(0,fc.jsx)(`div`,{ref:m,className:`w-full h-full relative overflow-hidden ${e}`,style:t})}export{gc as default};
...
const SidebarContent = ({ onNavClick }) => (
  <LiquidGlass
    ...
    elasticity={0.12}
    overLight={true}
    className="h-full w-64 flex flex-col border-r border-white/60"
  >
    <div className="h-16 flex items-center gap-3 px-6 border-b border-white/60 shrink-0">
  ...
  return (
    <>
      ...
      <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
        <SheetContent side="left" className="p-0 w-64 border-0 bg-transparent">

        ...
        <LiquidGlass cornerRadius={16} blurAmount={0.01} saturation={120} displacementScale={5} aberrationIntensity={0.5} elasticity={0.15} overLight={true} className="flex-1 flex flex-col h-full overflow-hidden relative border border-white/60">
          ...
          <div className="px-8 py-6 flex flex-col gap-6 flex-none z-10 border-b border-black/5 bg-white/20 backdrop-blur-md rounded-t-2xl">
              <div className="flex items-end justify-between">
                  <div>
                      <h1 className="text-slate-800 tracking-tight text-3xl font-bold leading-tight drop-shadow-sm">Kho Sản Phẩm</h1>
                      <p className="text-slate-500 text-sm mt-2 font-medium">Quản lý tồn kho đa nền tảng theo thời gian thực.</p>
                  </div>
                  <div className="flex gap-4">
                      ...
                      <button className="flex items-center justify-center rounded-full h-10 px-5 bg-gradient-to-r from-cyan-400/90 to-blue-400/90 hover:from-cyan-400 hover:to-blue-500 text-white text-sm font-bold leading-normal tracking-[0.015em] shadow-[0_4px_15px_rgba(0,208,224,0.3)] transition-all border border-white/60 backdrop-blur-md">
                          <span className="material-symbols-outlined mr-2 text-[20px]">add</span> <span className="truncate">Thêm Sản Phẩm</span>
                      </button>
                  </div>
              </div>
              ...
              <div className="flex flex-wrap gap-4 items-center justify-between">
                  <div className="flex flex-1 items-center bg-white/60 rounded-full border border-black/5 focus-within:border-cyan-300 focus-within:shadow-[0_0_15px_rgba(0,208,224,0.15)] focus-within:bg-white transition-all h-10 px-4 min-w-[280px] backdrop-blur-md shadow-inner">
                      ...
                      <input className="w-full bg-transparent border-none text-slate-800 placeholder:text-slate-400 focus:ring-0 text-sm ml-2 font-medium" placeholder="Tìm theo tên sản phẩm, mã SKU, hoặc thẻ AI..." />
                  </div>
                  <div className="flex items-center gap-2 overflow-x-auto no-scrollbar">
                      <button className="px-4 py-2 rounded-full bg-cyan-50 text-cyan-700 text-xs font-semibold whitespace-nowrap border border-cyan-200 shadow-sm backdrop-blur-sm">Tất cả</button>
                      <button className="px-4 py-2 rounded-full bg-white/60 text-slate-600 hover:bg-white hover:text-slate-900 transition-colors text-xs font-medium whitespace-nowrap border border-black/5 shadow-sm backdrop-blur-sm">Sắp hết hàng (3)</button>
          ...
          <div className="flex-1 overflow-auto px-8 pb-6 w-full pt-4 custom-scrollbar">
            ...
            <div className="grid grid-cols-12 gap-4 px-4 py-2 mb-2 text-xs font-bold text-slate-500 uppercase tracking-wider sticky top-0 z-10 bg-white/70 backdrop-blur-xl rounded-lg border border-white shadow-sm">
                ...
                <div className="col-span-2">Mã SKU & Danh mục</div>
                <div className="col-span-1 text-right">Giá bán</div>
                <div className="col-span-2 pl-4">Tình trạng Kho</div>
            ...
            <div className="space-y-3">
              ...
              <div className="glass-row grid grid-cols-12 gap-4 items-center p-4 relative overflow-hidden ring-1 ring-cyan-200 bg-cyan-50/30">
                  ...
                  <div className="col-span-2">
                      ...
                      <div className="mt-1"><span className="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold bg-purple-100 text-purple-700 border border-purple-200">Giày dép</span></div>
                  </div>
                  <div className="col-span-1 text-right">
                      <div className="text-sm font-bold text-slate-800">1.250.000đ</div>
                      <div className="text-xs text-slate-400 line-through font-medium">1.500.000đ</div>
                  </div>
                      ...
                      <div className="flex flex-col gap-1.5">
                          <div className="flex items-center gap-2">
                              <div className="h-2 w-16 bg-slate-100 rounded-full overflow-hidden border border-slate-200 shadow-inner">
                               ...
                               <span className="text-xs font-bold text-emerald-600">Còn 42</span>
                           </div>
                           <span className="text-[10px] text-slate-500 uppercase tracking-wider font-semibold">Mức an toàn</span>
                      </div>
                  </div>
                  <div className="col-span-2">
                      ...
                      <div className="flex flex-col gap-1.5">
                          <div className="flex items-center gap-2">
                              <div className="h-2 w-16 bg-slate-100 rounded-full overflow-hidden border border-slate-200 shadow-inner">
                               ...
                               <span className="text-xs font-bold text-rose-600">Còn 3</span>
                           </div>
                           <span className="text-[10px] text-rose-500 uppercase tracking-wider font-semibold">Cần nhập thêm</span>
                      </div>
                  </div>
                  <div className="col-span-2">
                      <div className="flex items-center -space-x-2">
          ...
          <div className="px-8 py-4 border-t border-black/5 flex items-center justify-between z-10 bg-white/30 backdrop-blur-xl rounded-b-2xl shadow-[0_-4px_10px_rgba(0,0,0,0.02)]">
              <div className="text-xs text-slate-500 font-medium">Đang hiển thị <span className="font-bold text-slate-800">1-10</span> của <span className="font-bold text-slate-800">45</span> sản phẩm</div>
              <div className="flex gap-2">
                  ...
                  <button className="px-4 py-1.5 rounded-full bg-white/80 text-slate-700 hover:bg-white hover:text-slate-900 text-xs font-bold transition-all border border-slate-200 backdrop-blur-sm shadow-sm">Trang sau</button>
              </div>
          </div>
        </LiquidGlass>
        ...
        <aside className="w-[420px] rounded-2xl glass-drawer flex flex-col relative z-30 transition-transform duration-300 transform translate-x-0 overflow-hidden border border-white/80">
              ...
              <section>
                  ...
                  <div className="bg-white/60 rounded-2xl p-5 border border-white shadow-[0_4px_15px_rgba(0,0,0,0.03)] backdrop-blur-md">
                      <div className="flex justify-between items-center mb-5">
                          <span className="text-sm font-medium text-slate-500">Tổng Số Lượng</span>
          ...
          <div className="p-6 border-t border-white bg-white/70 relative z-10 backdrop-blur-xl shadow-[0_-10px_30px_rgba(0,0,0,0.05)]">
              <div className="flex gap-4">
                  ...
                  <button className="flex-1 h-12 rounded-xl bg-gradient-to-r from-cyan-400 to-blue-500 hover:from-cyan-500 hover:to-blue-600 text-white font-bold text-sm shadow-[0_4px_15px_rgba(0,208,224,0.3)] hover:shadow-[0_6px_20px_rgba(0,208,224,0.4)] transition-all border border-white/50">Lưu Thay Đổi</button>
              </div>
          </div>
        </aside>
